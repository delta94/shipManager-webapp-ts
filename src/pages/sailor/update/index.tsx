...
import { updateSailor, listSailorPosition, infoSailor } from '@/services/sailor';
...
const SailorUpdate: React.FC<RouteComponentProps<{ id: string }>> = ({ match: { params } }) => {
  const [form] = Form.useForm();
  const dispatch = useDispatch();

  useRequest(infoSailor, {
  ...
  const { loading, run: updateSailorInfo } = useRequest(updateSailor, {
    manual: true,
    onSuccess: () => {
